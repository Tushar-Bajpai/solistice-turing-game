...
export default function RestorationComplete({ setCurrentScreen, currentScreen }) {
  useEffect(() => {
    /* 
...
void main() {
  ...
  return (
    <>
      {/*  STITCH_SHADER_START:ANIMATION_10 className="fixed inset-0 w-full h-full -z-10 opacity-60 pointer-events-none"  */}
...
<span className="text-label-caps text-soft-green glow-gold">SYSTEM_STATUS</span>
...
<span className="animate-pulse glow-gold">STABLE</span>
</div>
